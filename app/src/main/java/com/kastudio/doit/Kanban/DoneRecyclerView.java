...
public class DoneRecyclerView extends RecyclerView.Adapter<DoneRecyclerView.PostHolder> {
    ...
    public DoneRecyclerView(ArrayList<String> note, ArrayList<Integer> color, ArrayList<String> uuid){
        this.note = note;
        this.color = color;
        this.uuid = uuid;
    }
    ...
    @NonNull
    @Override
    public DoneRecyclerView.PostHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DoneRecyclerView.PostHolder holder, int position) {
